...
classDiagram
   class ClassName {
       +publicAttritbueName: AttributeType
       #protectedAttributeName: AttributeType
       -privateAttributeName: AttributeType
       +publicOperation(argument: ArgumentType) ReturnType
       #protectedOperation(argument: ArgumentType) ReturnType
       -privateOperation(argument: ArgumentType) ReturnType
       +publicStaticOperation(argument: ArgumentType)$ ReturnType
   }
